...
public class Buzon {
    ...
    public void recibirMensaje(Mensaje mensaje) {
        ...
        if (suscriptores.contains(mensaje.getDestinatario())) {
            ...
            System.out.println("Mensaje reenviado al siguiente buzón");
        } else {
            System.out.println("Mensaje no añadido: persona no encontrada en la lista de buzones");
        }
    }
        ...
        public void ignorarMensaje (Mensaje mensaje){
            System.out.println("Mensaje de " + mensaje.getRemitente().getNombre() + " a " + mensaje.getDestinatario().getNombre() + " fue ignorado.");
